...
class MainMenuForm(QWidget):
    ...
    # In your MainMenuForm class definition, replace the existing open_ticket_window method with this one.
    def open_ticket_window(self):
        print("Opening Ticket Window")
        self.hide()
        self.ticket_win = TicketWindow()
        print("Ticket Window created")
