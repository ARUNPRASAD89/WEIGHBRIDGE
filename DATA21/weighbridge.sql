...
--
-- Name: FormulaTable; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."FormulaTable" (
    "FormulaId" integer NOT NULL,
    "strFormulaName" character varying(50),
    "formulaList" character varying(200)
);


ALTER TABLE public."FormulaTable" OWNER TO postgres;

--
-- Name: FormulaTable_FormulaId_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."FormulaTable_FormulaId_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public."FormulaTable_FormulaId_seq" OWNER TO postgres;

--
-- Name: FormulaTable_FormulaId_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."FormulaTable_FormulaId_seq" OWNED BY public."FormulaTable"."FormulaId";
...
--
-- Name: tablemaster; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tablemaster (
    fieldcaption character varying(50),
    fieldname character varying(50),
    fieldsize integer,
    fieldidtype character varying(50),
    id integer NOT NULL,
    mandatory boolean,
...
ALTER TABLE public.tablemaster OWNER TO postgres;

--
-- Name: tablemaster_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.tablemaster_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.tablemaster_id_seq OWNER TO postgres;

--
-- Name: tablemaster_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.tablemaster_id_seq OWNED BY public.tablemaster.id;
...
--
-- Name: ticketdatatemplate; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ticketdatatemplate (
    controlid integer,
    controlht integer,
    controlwd integer,
    controltop integer,
    ...
    controlcaption character varying(50),
    controltype character varying(50),
    controlarrid integer,
    controltable character varying(50),
    controlticketref character varying(50),
    controldisablefirst boolean,
    controldisablesecond boolean,
    controldisablesingle boolean
);


ALTER TABLE public.ticketdatatemplate OWNER TO postgres;
...
--
-- Name: FormulaTable FormulaId; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."FormulaTable" ALTER COLUMN "FormulaId" SET DEFAULT nextval('public."FormulaTable_FormulaId_seq"'::regclass);
...
--
-- Name: tablemaster id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tablemaster ALTER COLUMN id SET DEFAULT nextval('public.tablemaster_id_seq'::regclass);
...
--
-- Data for Name: FormulaTable; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."FormulaTable" ("FormulaId", "strFormulaName", "formulaList") FROM stdin;
1	TAMOUNT	LAMOUNT+EAMOUNT
\.
...
--
-- Data for Name: tablemaster; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tablemaster (fieldcaption, fieldname, fieldsize, fieldidtype, id, mandatory, tablename) FROM stdin;
\.
...
--
-- Data for Name: ticketdatatemplate; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.ticketdatatemplate (controlid, controlht, controlwd, controltop, controllt, controlname, controlcaption, controltype, controlarrid, controltable, controlticketref, controldisablefirst, controldisablesecond, controldisablesingle) FROM stdin;
\.
...
COPY public.tickets ("TicketNumber", "VehicleNumber", "Date", "Time", "EmptyWeight", "LoadedWeight", "EmptyWeightDate", "EmptyWeightTime", "LoadWeightDate", "LoadWeightTime", "NetWeight", "Pending", "Closed", "Exported", "Shift", "Materialname", "SupplierName", "State", "TEST") FROM stdin;
1	TN20AS5979	2025-07-06	23:47:51	6542	\N	\N	\N	\N	\N	6542	\N	\N	\N	\N			first transaction	\N
2	TN12AL8933	2025-07-06	23:52:44	\N	39020	2025-07-06	23:52:44	2025-07-06	23:52:44	39020	t	f	f	B			first transaction	\N
4	TN77Q0505	2025-07-07	00:34:34	7235	\N	\N	\N	\N	\N	7235	\N	\N	\N	\N			first transaction	\N
6	TN05RS5050	2025-07-07	20:01:09	11007	\N	2025-07-07	20:01:09	2025-07-07	20:01:09	11007	t	f	f	B			first transaction	\N
7	TN77RS4545	2025-07-07	20:04:09	5438	\N	\N	\N	\N	\N	5438	\N	\N	\N	\N			first transaction	\N
8	TN77MN0505	2025-07-07	20:13:52	10003	\N	2025-07-07	20:13:52	2025-07-07	20:13:52	10003	t	f	f	B			first transaction	\N
9	TN05FG7894	2025-07-07	20:29:09	9912	\N	2025-07-07	20:29:09	2025-07-07	20:29:09	9912	t	f	f	B			first transaction	\N
10	TN77F3456	2025-07-07	20:59:47	\N	17435	2025-07-07	20:59:47	2025-07-07	20:59:47	17435	t	f	f	B			first transaction	\N
11	MH04FG7894	2025-07-07	21:30:26	9385	\N	2025-07-07	21:30:26	2025-07-07	21:30:26	9385	t	f	f	B			first transaction	\N
3	TN20BP0505	2025-07-07	22:44:48	23471	24006	2025-07-07	22:44:48	2025-07-07	22:44:48	535	f	t	f	B			second transaction	\N
16	TN45RS7575	2025-07-07	22:57:08	10602	\N	2025-07-07	22:57:08	2025-07-07	22:57:08	10602	t	f	f	B			first transaction	\N
20	TN70F1234	2025-07-07	23:37:03	\N	32644	2025-07-07	23:37:03	2025-07-07	23:37:03	32644	t	f	f	B			first transaction	\N
19	TN05JK7575	2025-07-07	23:36:19	11410	6319	2025-07-07	23:36:19	2025-07-07	23:36:19	-5091	f	t	f	B			second transaction	\N
5	NL01LM7531	2025-07-07	00:41:03	5278	5290	2025-07-07	00:41:03	2025-07-07	00:41:03	12	f	t	f	B			second transaction	\N
12	TN45ST7894	2025-07-07	21:47:32	9630	13617	2025-07-07	21:47:32	2025-07-07	21:47:32	3987	f	t	f	B			second transaction	\N
14	TN05CD5050	2025-07-07	21:58:07	9425	6347	2025-07-07	21:58:07	2025-07-07	21:58:07	-3078	f	t	f	B			second transaction	\N
13	TN07IJ0555	2025-07-07	21:49:33	11571	13558	2025-07-07	21:49:33	2025-07-07	21:49:33	1987	f	t	f	B			second transaction	\N
15	TN77RS4141	2025-07-07	22:52:41	11650	13038	2025-07-07	22:52:41	2025-07-07	22:52:41	1388	f	t	f	B			second transaction	\N
17	TN77XR1111	2025-07-07	23:10:37	10557	14871	2025-07-07	23:10:37	2025-07-07	23:10:37	4314	f	t	f	B			second transaction	\N
18	TN12HP0505	2025-07-07	23:22:54	9496	10865	2025-07-07	23:22:54	2025-07-07	23:22:54	1369	f	t	f	B			second transaction	\N
21	TN20AT7575	2025-07-09	15:19:08	11530	\N	2025-07-09	15:19:08	2025-07-09	15:19:08	11530	t	f	f	B			first transaction	\N
\.
...
--
-- Name: FormulaTable_FormulaId_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."FormulaTable_FormulaId_seq"', 1, true);
...
--
-- Name: tablemaster_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.tablemaster_id_seq', 1, false);
...
--
-- Name: FormulaTable FormulaTable_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."FormulaTable"
    ADD CONSTRAINT "FormulaTable_pkey" PRIMARY KEY ("FormulaId");
...
--
-- Name: tablemaster tablemaster_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tablemaster
    ADD CONSTRAINT tablemaster_pkey PRIMARY KEY (id);
