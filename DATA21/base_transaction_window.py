...
class BaseTransactionWindow(QWidget):
    def __init__(self, parent=None):
        ...
        # CUSTOM FIELDS (empty, but section present)
        cust_frame = QFrame()
    ...
    def handle_exit(self):
        from main_menu_form import MainMenuForm  # <-- import here, not at the top
        self.close()
        self.menu = MainMenuForm()
        self.menu.show()  
