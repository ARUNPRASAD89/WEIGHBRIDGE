...
class MainMenuForm(QWidget):
    ...
    # Updated: now opens BaseTransactionWindow instead of TicketWindow
    def open_ticket_window(self):
        print("Opening Transaction Window")
        self.hide()
        self.ticket_win = BaseTransactionWindow()
        print("Transaction Window created")
