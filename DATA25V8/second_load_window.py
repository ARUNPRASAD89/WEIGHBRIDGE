...
from PyQt5.QtCore import Qt, QDate, QTime, QTimer, QLocale, QCoreApplication
...
class SecondLoadWindow(QWidget):
    ...
    def _create_keyboard(self):
        ...
        clear_btn = QPushButton("Clear"); clear_btn.setFont(self.digit_font); clear_btn.setFixedSize(92, 52); clear_btn.setStyleSheet("background-color: red; color: white; font-weight: bold;"); clear_btn.clicked.connect(self.clear_all_fields); keypad_layout.addWidget(clear_btn, 3, 10)
    ...
    def update_live_weight(self, weight):
        """Updates the weight display label."""
    ...
    def ok_pressed(self):
        ...
        if data:
            ...
            try:
                ...
                QMessageBox.critical(self, "Weight Error", "Invalid weight received from the weighbridge.")
                return
