...
from PyQt5.QtWidgets import (
    ...
    QTableWidget, QTableWidgetItem, QLineEdit, QWidget, QScrollArea
)
from PyQt5.QtCore import QDateTime, QDate, QTime, QLocale, Qt
...
class SecondTransactionWindow(BaseTransactionWindow):
    def __init__(self, parent=None, pending_ticket_number=None):
        ...
        self.set_active_transaction_buttons('second')
